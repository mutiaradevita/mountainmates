                ...
                <div class="bg-white rounded-lg shadow-sm border">
                    ...
                    <div class="divide-y">
                        ...
                        <div class="p-6 hover:bg-mist transition-colors">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900">Sorong - Surabaya</h3>
                                        <p class="text-sm">
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>Min, 20 Apr 2025 • 08:30</p>
                                <p>Multiple Airlines • Dominique Edward Osok</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6 hover:bg-mist transition-colors">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900">Surabaya - Sorong</h3>
                                        <p class="text-sm">
                                            <span class="inline-block px-2 py-1 text-sm rounded text-forest">
                                                Selesai
                                            </span>
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>Sen, 17 Mar 2025 • 19:45</p>
                                <p>Multiple Airlines • Juanda</p>
                            </div>
                        </div>
                        ...
                        <div class="p-8 text-center">
                            ...
                            <a href="#" class="inline-flex items-center px-4 py-2 bg-forest text-white rounded-lg hover:bg-moss transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
